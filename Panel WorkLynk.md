...
Facturas (desde `748dce8`): el PDF es una factura completa de autónomo según el RD 1619/2012. El emisor es la persona física y WORKLYNK aparece como nombre comercial. Lleva IVA y retención de IRPF, y `invoice_totals.total` es lo que paga el cliente. Requiere la migración `202609240014_invoice_legal.sql`. Pendiente: facturas rectificativas y Veri*factu.
