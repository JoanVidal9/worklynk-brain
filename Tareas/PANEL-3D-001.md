...
- Pendiente: Joan dice que el panel de Agentes tiene «mucho ruido y no se entiende nada». Propuesta de menú simplificado enviada (Pendiente · Equipo · Trabajos, ficha por agente, detalle de trabajo como línea de tiempo); esperar su elección antes de implementar.
