...
- 2026-09-24, 128509e: Joan retira el minimapa (no le gusta; eliminado con su estado). Entrada de cámara al abrir la vista general y nombres de los agentes siempre visibles (compactos lejos; nombre y estado cerca o dentro de Agentes). Encuadre más abierto al entrar en Agentes.
- Agentes en versión limpia (Joan: «muy limpio»): pestañas Pendiente · Equipo · Trabajos, un solo «Nuevo objetivo», ficha por agente (Consejo en la del CEO), trabajo como historia. Clases `ag-*` en agents.css; la ruta DEV `/preview/command-center/agents/equipo` sirve para revisarlo.
- 2026-09-25, 902a957 · 9036f7e · e4d6c45: maqueta de arquitecto (pabellones con mobiliario, atrio del CEO, arbolado y figuras, luz de estudio, sombras y N8AO), barra superior de áreas con «Ir a…» (Ctrl K), volumen sin columna de iconos, sistema de componentes común y acceso en claro con la maqueta de fondo. Se mantienen los nombres de agentes siempre visibles y sin minimapa. Pendiente: verlo con sesión real y el feedback de Joan.
